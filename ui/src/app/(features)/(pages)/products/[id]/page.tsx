...
import { useProductDetails, useProductReviews } from "@/app/(features)/_api/product";
import { useAddToCart } from "@/app/(features)/_api/cart"; 
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex gap-3">
                                ...
                                <button
                                    ...
                                    className="flex-1 bg-primary hover:bg-blue-700 text-white py-3 px-6 rounded-lg font-medium transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
                                >
                            ...
                            <div className="grid grid-cols-1 gap-6">
                                {Object.entries(product.specifications || {}).map(
                                    ([key, value]) => (
                                        <div
                                            key={key}
                                            className="flex flex-col gap-2 md:flex-row justify-between py-3 border-b border-gray-100"
                                        >
