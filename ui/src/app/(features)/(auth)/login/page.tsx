      ...
      <div className="w-full max-w-6xl mx-auto flex items-center justify-center relative z-10">
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 overflow-hidden w-full max-w-4xl">
          <div className="flex flex-col lg:flex-row md:min-h-[500px]">
            {/* <div className="lg:w-1/2 bg-gradient-to-br from-indigo-600 via-purple-600 to-blue-700 p-4 md:p-6 lg:p-8 flex flex-col justify-between text-white relative overflow-hidden"> */}
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-12 py-2 md:py-4 border border-gray-200 rounded-lg md:rounded-2xl focus:ring-0 focus:border-transparent transition-all duration-200 bg-gray-50/50 backdrop-blur-sm text-gray-900 placeholder-gray-500 text-sm md:text-base"
                    ...
                    >
                      {showPassword ? (
                        <Eye className="w-4 h-4 md:h-5 md:w-5" />
                      ) : (
                        <EyeOff className="w-4 h-4 md:h-5 md:w-5" />
                      )}
                    </button>
                  </div>
