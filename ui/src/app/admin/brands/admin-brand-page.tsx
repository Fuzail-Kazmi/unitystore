...
// import {
//   Plus, Search, Edit, Trash2, Tag, ChevronLeft, Save, Upload, Calendar
// } from 'lucide-react';
...
//       id: '3',
//       name: 'UnityAlgo',
//       description: 'Pakistan multinational computer technology company',
//       image: '/logo.png',
...
//                   className={`w-full px-3 py-2 border rounded-lg text-sm focus:ring-1 focus:ring-blue-500 focus:border-blue-500 ${errors.name ? 'border-red-300' : 'border-gray-300'
//                     }`}
...
const AdminBrandsPage = () => {
  ...
  if (currentView === "add") return <BrandForm mode="add" setCurrentView={setCurrentView} />;
  if (currentView === "edit" && selectedBrand)
    return <BrandForm brand={selectedBrand} mode="edit" setCurrentView={setCurrentView} />;
  if (currentView === "detail" && selectedBrand)
    return (
      <BrandDetail
        brand={selectedBrand}
