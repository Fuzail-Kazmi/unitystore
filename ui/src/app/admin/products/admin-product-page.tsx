            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-3 py-2 border rounded-lg focus:ring-1 focus:ring-blue-500 focus:border-blue-500 ${errors.price ? 'border-red-300' : 'border-gray-300'
                    }`}
                  placeholder="0.00"
                  step="0.01"
                />
    ...
    <div className="p-6">
      <div className="flex items-center justify-between mb-4 pb-2 border-b border-gray-200">
        <div>
          ...
          <p className="text-gray-600 text-xs sm:text-sm">Manage your product catalog</p>
        </div>
        <button
