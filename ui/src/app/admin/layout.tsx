...
//         <div
//           className={`fixed top-0 left-0 h-full z-40 transition-all duration-500 ease-in-out bg-white shadow-sm border-r border-gray-200 
...
//             className={`absolute top-0 z-50 h-full w-6 flex items-center justify-center 
